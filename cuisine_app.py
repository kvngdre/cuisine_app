...
#
#
# model = get_model(link=url)
#
# options = st.multiselect(label='Pick at least seven ingredients',
...
#
# st.write('Given the ingredients this dish is:', prediction[0], 'cuisine.')
...
image = Image.open('https://github.com/kvngdre/cuisine_app/blob/main/testimage.jpg')
st.image(image)
